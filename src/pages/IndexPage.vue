<template>
  <q-page class="column full-height chat-page">
    ...
    <div class="chat-container col full-width scroll" ref="chatArea">
      ...
      <!-- Welcome state -->
      <div v-if="messages.length === 1 && messages[0].role === 'assistant'" class="welcome-area">
        <!-- Welcome Logo -->
        <svg width="80" height="80" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg" class="welcome-logo">
          <circle cx="19" cy="19" r="17" stroke="url(#wRingGrad)" stroke-width="1.5" stroke-dasharray="6 4" fill="none"
      ...
      <!-- Typing indicator -->
      <div v-if="isProcessing" class="q-mb-md flex justify-start">
        <div>
    ...
    <div class="chat-input-area full-width">
      <div class="row items-center no-wrap" style="max-width: 860px; margin: 0 auto;">
        <q-input
          v-model="newMessage"
          dark
          color="teal"
      ...
      <div style="text-align: center; margin-top: 6px;">
        <span style="font-family: 'Open Sans', sans-serif; font-size: 0.68rem; color: var(--mist); opacity: 0.35; letter-spacing: 0.5px;">
...
const messages = ref([
  { role: 'assistant', content: 'Welcome to the MBRP Research Paper Database. How can I assist you with microbial biotechnology today? I can help summarize papers, provide methodology details, or analyze data trends.' }
])
